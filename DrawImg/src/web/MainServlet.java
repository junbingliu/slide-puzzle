...
public class MainServlet extends HttpServlet{
    ...
    //写图片的位置
    private static final String IMG_DIR="D:\\workspace\\IdeaJavaProject\\DrawImg\\out\\artifacts\\DrawImg_war_exploded\\resource\\image\\drawImg";
    //读图片的位置
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if ("/drawImg.do".equals(path)) {
            ...
            int realX=0;
            int bcImgWidth=0;
            realX = (int)session.getAttribute("realX");
            bcImgWidth = (int)session.getAttribute("bcImgWidth");
            //按实际比例计算浏览器位移
