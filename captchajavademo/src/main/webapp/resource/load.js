    ...
    return function(t) {
        ...
        , function(t, r) {
            ...
            var i, a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
                ...
                , c = "prototype", u = 100, s = 200, l = 500, f = 501, p = 502, h = 503, d = 504, y = 1e3, v = (i = {},
                n(i, u, "script error"),
                n(i, s, "business error"),
                n(i, l, "request error"),
                n(i, f, "request api error"),
                n(i, p, "request script error"),
                n(i, h, "request img error"),
                n(i, d, "request timeout error"),
                n(i, y, "unknown error"),
                i);
            e(o, Error),
                ...
                ,
                o.set = function(t, r) {
                    "number" == typeof t && "string" == typeof r && (v[t] = r),
                    "object" === ("undefined" == typeof t ? "undefined" : a(t)) && t && Object.assign(v, t)
                }
                ,
                o.get = function(t) {
                    return v[t]
                ...
                r.BUSINESS_ERROR = s,
                r.REQUEST_ERROR = l,
                r.REQUEST_API_ERROR = f,
                r.REQUEST_SCRIPT_ERROR = p,
                r.REQUEST_IMG_ERROR = h,
                r.REQUEST_TIMEOUT_ERROR = d,
                r.UNKNOWN_ERROR = y
        }
        , function(t, r, n) {
            function e(t, r) {
                var n = {};
                for (var e in t)
                    r.indexOf(e) >= 0 || Object.prototype.hasOwnProperty.call(t, e) && (n[e] = t[e]);
                return n
            }
        ...
        , function(t, r) {
            ...
            Object.assign(n.prototype, {
                then: function(t, r) {
                    ...
                    return n(t) && this._fullfilledCallback.push(t),
                    n(r) && this._rejectedCallback.push(r),
        ...
        , function(t, r, n) {
            ...
            var o, i = n(5), a = n(4), c = n(1), u = c.REQUEST_SCRIPT_ERROR, s = c.REQUEST_API_ERROR, l = c.REQUEST_IMG_ERROR, f = n(3), p = n(2), h = (o = {},
                e(o, s, "api"),
                e(o, l, "image"),
                e(o, u, "script"),
                o), d = null;
            t.exports = function(t, r, n) {
                var e = r.protocol
                    ...
                    , v = y(o || c.apiServer || ["c.dun.163yun.com", "c.dun.163.com"])
                    , m = i({
                    timeout: s,
                    disableRetry: !0
                })
        ...
        , function(t, r) {
            ...
            function e(t, r, e, a) {
                ...
                function s(t) {
                    var r = [];
                    for (var n in t)
                        t.hasOwnProperty(n) && r.push(m(n) + "=" + m(t[n]));
                    return r.join("&")
                }
                "object" === ("undefined" == typeof e ? "undefined" : o(e)) && (a = e,
                    e = null),
                "function" == typeof r && (e = r,
                    r = null),
                a || (a = {});
                var l, f, p = Math.random().toString(36).slice(2, 9), h = a.prefix || "__JSONP", d = a.name || h + ("_" + p) + ("_" + i++), y = a.param || "callback", v = a.timeout || 6e3, m = window.encodeURIComponent, _ = document.getElementsByTagName("script")[0] || document.head;
        ...
        , function(t, r, n) {
            ...
            t.exports = e,
                Object.assign(e.prototype, {
                    ...
                    emit: function(t) {
                        for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), e = 1; e < r; e++)
                            n[e - 1] = arguments[e];
        ...
        , function(t, r, n) {
            function e(t, r, n) {
                ...
                var h = function(r) {
                    ...
                    , y = p[d] || i.script({
                    id: d,
                    url: h(t.staticServer || ["cstaticdun.126.net", "cstatic.dun.163yun.com"]),
                    timeout: t.timeout,
                    onTryError: l(t)
                });
                !p[d] && (p[d] = y),
        ...
        , function(t, r, n) {
            function e(t, r) {
                if (!t)
                    throw new Error("[NECaptcha Loader] " + r)
            }
            function o(t) {
                s.call(this),
                    e(t.captchaConfig, 'option "captchaConfig" is required.'),
                    e(t.cache, 'option "cache" is required.'),
            ...
            var i = Object.assign || function(t) {
                ...
                , f = n(2)
                , p = n(6)
                , h = u.REQUEST_API_ERROR
                , d = u.REQUEST_SCRIPT_ERROR
                , y = u.UNKNOWN_ERROR
                , v = !1;
            l(o, s),
                        ...
                        var f = function() {
                            ...
                            _(d, y, function(n, e) {
                                ...
                                var a = function(t) {
                                    ...
                                    null == n.apiServer && (n.apiServer = t.apiServer),
                                    null == n.staticServer && (n.staticServer = t.staticServers),
                                        n.theme = t.theme,
                                        n.__serverConfig__ = t
                                }
                                    , c = e.data;
                                v && l && (c = l),
                                    a(c),
                                    r.emit("after-config", r._captchaConfig.__serverConfig__).then(t)["catch"](function(t) {
        ...
        , function(t, r) {
            ...
            function e(t, r) {
                t.onload = function() {
                    ...
                    t.onerror = function() {
                        this.onerror = this.onload = null,
                            r(new Error("Failed to load " + this.src), t)
                    }
            }
            function o(t, r) {
            ...
            t.exports = function(t, r, i) {
                ...
                "function" == typeof r && (i = r,
                    ...
                    i = i || function() {}
                    ,
                    c.type = r.type || "text/javascript",
                    c.charset = r.charset || "utf8",
                    c.async = !("async"in r) || !!r.async,
                    c.src = t,
                r.attrs && n(c, r.attrs),
                r.text && (c.text = "" + r.text);
